...
randomNA_num = dim(cdr_2.2)[1] * dim(cdr_2.2)[2] * 0.15
...
RNAseq_meta_simu$C_type[RNAseq_meta_simu$C_type == "grp2"] = "grp1"

set.seed(123)
idx = sample(1:ncol(cdr_r), ncol(cdr_r), replace = FALSE)
cdr_r = cdr_r[, idx]
...
write.csv(RNAseq_meta_simu, here(dataFolder, "simu2_RNAseq_meta_noise.csv"))
